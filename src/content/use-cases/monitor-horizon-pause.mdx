...
Good, I now have a clear sense of the style, structure, and voice. Let me write the MDX content for the `horizon:pause` monitoring page. This is a use-cases page based on the pattern.

Now I need to determine where this file should go. Based on the existing pattern (`monitor-horizon-work.mdx`, `monitor-horizon-terminate.mdx`), it should be `src/content/use-cases/monitor-horizon-pause.mdx`.

Let me write the content. The user asked for ONLY the MDX body, no frontmatter.
